...
function installGISettings3942(){
  ...
  if(primary){
    primary.innerHTML='<option value="Irradiance">Irradiance</option>';
    primary.value='Irradiance';
    primary.disabled=false;
    primary.title='LitePix irradiance-cache / hierarchical GI';
  }
  if(secondary){
    secondary.innerHTML='<option value="Light Cache">Light Cache</option><option value="None">None</option>';
    secondary.value='Light Cache';
    secondary.disabled=false;
    secondary.title='LitePix secondary GI cache';
  }
