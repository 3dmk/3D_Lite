...
# Promote public identity while preserving legacy 3DLite aliases.
...
rep="const LitePixVersion=Object.freeze({name:'LitePix',version:'4.08.0'});"
s,n=re.subn(pat,rep,s,count=1)
if n!=1: raise SystemExit('release-blocking: LitePixVersion anchor not found')
# Add native LitePix subsystem modules exactly once and after the established editor scripts.
...
# Compatibility marker is intentionally additive; old 3DLite APIs remain.
