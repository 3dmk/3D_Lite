...
const files=['index.html','r3d-editor.js','r3d-renderer.js','r3d-render-watchdog.js','r3d-output-orientation.js','r3d-bootstrap.js'];
...
if(JSON.stringify(scripts)!==JSON.stringify(['r3d-editor.js','r3d-renderer.js','r3d-render-watchdog.js','r3d-output-orientation.js','r3d-bootstrap.js']))fail('script load order changed');
for(const f of ['r3d-editor.js','r3d-renderer.js','r3d-render-watchdog.js','r3d-output-orientation.js','r3d-bootstrap.js']){
...
const ed=read('r3d-editor.js'),ren=read('r3d-renderer.js'),watch=read('r3d-render-watchdog.js'),orient=read('r3d-output-orientation.js'),boot=read('r3d-bootstrap.js');
...
console.log(`IDs=${ids.length} scripts=${scripts.length} editor=${ed.length} renderer=${ren.length} watchdog=${watch.length} orientation=${orient.length}`);